...
public class Livre {
    ...
    public Livre(String titre, String auteur, float prix, String image) {
        this.titre = titre;
        this.auteur = auteur;
        this.prix = prix;
        this.image = image;
    ...
    public String toString() {
        return "Livre{" + "idLivre=" + id_livre + ", Label=" + id_categorie + ", titre=" + titre + ", nomAuteur=" + auteur + ", genre=" + genre + ",  prix=" + prix + ", Image=" + image + '}';
    }
